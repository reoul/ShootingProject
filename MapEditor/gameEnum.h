...
enum DISTANCE_TYPE { LEFT = 1, RIGHT, UP, DOWN, LEFTUP, RIGHTUP, LEFTDOWN, RIGHTDOWN };	//방향을 설명

enum ACTION_TYPE { IDLE = 0, MOVE, RUN, ROLL, ATTACK, SLEEP, DEAD, SKILL, FAINT};	//무슨 행동을 취하는지
